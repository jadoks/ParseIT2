...
const styles = StyleSheet.create({
  ...
  stateText: { fontFamily: FONT_BODY, marginTop: 12, color: '#606060', fontSize: 15 },
  errorText: { fontFamily: FONT_BODY, color: '#D32F2F', fontSize: 15, textAlign: 'center' },
  ...
  feedAvatarText: { fontFamily: FONT_BODY, color: '#fff', fontWeight: WEIGHT_EMPHASIS },
  ...
  backBtnText: { fontFamily: FONT_BODY, fontWeight: WEIGHT_EMPHASIS, color: '#111' },
  ...
  watchTitle: { fontFamily: FONT_TITLE, fontSize: 20, fontWeight: WEIGHT_TITLE, color: '#111', lineHeight: 28 },
  watchSubMeta: { fontFamily: FONT_BODY, marginTop: 6, fontSize: 13, color: '#606060' },
  ...
  channelAvatarText: { fontFamily: FONT_BODY, color: '#fff', fontWeight: WEIGHT_EMPHASIS },
  channelName: { fontFamily: FONT_BODY, fontSize: 15, fontWeight: WEIGHT_EMPHASIS, color: '#111' },
  channelSubs: { fontFamily: FONT_BODY, fontSize: 12, color: '#606060', marginTop: 2 },
  ...
  actionPillText: { fontFamily: FONT_BODY, fontWeight: WEIGHT_EMPHASIS, color: '#111' },
  actionPillTextActive: { color: '#fff' },
  descriptionCard: { backgroundColor: '#f7f7f7', borderRadius: 14, padding: 12 },
  descriptionText: { fontFamily: FONT_BODY, color: '#222', fontSize: 14, lineHeight: 20 },
  ...
  commentUser: { fontFamily: FONT_BODY, fontWeight: WEIGHT_EMPHASIS, color: '#111', marginBottom: 2 },
  commentDate: { fontFamily: FONT_BODY, color: '#888', fontSize: 12, marginBottom: 4 },
  commentText: { fontFamily: FONT_BODY, color: '#222', fontSize: 14, lineHeight: 20 },
  editRow: { marginTop: 4 },
  ...
  relatedTitle: { fontFamily: FONT_TITLE, fontSize: 15, fontWeight: WEIGHT_TITLE, color: '#111', lineHeight: 21 },
  relatedChannel: { fontFamily: FONT_BODY, marginTop: 6, color: '#606060', fontSize: 13 },
  relatedMeta: { fontFamily: FONT_BODY, marginTop: 4, color: '#606060', fontSize: 12 },
});
