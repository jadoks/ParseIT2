...
const styles = StyleSheet.create({
  ...
  heroSubtitle: { fontFamily: FONT_TITLE, fontSize: 14, color: COLORS.subtext, lineHeight: 22 },
  ...
  metricSubtitle: { fontFamily: FONT_TITLE, fontSize: 12, color: '#9CA3AF', marginLeft: 6, lineHeight: 18 },
  ...
  floatingLabelText: { fontFamily: FONT_BODY, fontSize: 10, fontWeight: WEIGHT_EMPHASIS, color: COLORS.text, backgroundColor: 'rgba(255,255,255,0.95)', paddingHorizontal: 4, paddingVertical: 2, borderRadius: 6, overflow: 'hidden', textAlign: 'center' },
  ...
  subjectTitle: { fontFamily: FONT_TITLE, fontSize: 16, fontWeight: WEIGHT_TITLE, color: COLORS.text },
