  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.sectionCard}>
        ...
        <Text style={styles.sectionCaption}>Subjects are ranked by academic risk. Highest-risk subjects are shown first.</Text>
...
const styles = StyleSheet.create({
  ...
  heroEyebrow: { fontSize: 12, fontWeight: '700', color: COLORS.primary, textTransform: 'uppercase', letterSpacing: 0.6, marginBottom: 6 },
  heroTitle: { fontSize: 24, fontWeight: '800', color: COLORS.text, marginBottom: 6 },
  heroSubtitle: { fontSize: 14, color: COLORS.subtext, lineHeight: 22 },
  riskPillWrap: { marginTop: 16, alignSelf: 'flex-start' },
  riskPillLabel: { fontSize: 12, color: COLORS.subtext, marginBottom: 6, fontWeight: '600' },
  ...
  metricTitle: { fontSize: 13, color: COLORS.subtext, marginBottom: 8, marginLeft: 6 },
  metricRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  metricValue: { fontSize: 20, fontWeight: '800', color: COLORS.text, marginBottom: 4, marginLeft: 6, flexShrink: 1 },
  metricSubtitle: { fontSize: 12, color: '#9CA3AF', marginLeft: 6, lineHeight: 18 },
  trendBadge: { fontSize: 13, fontWeight: '800' },
  ...
  sectionCaption: { fontSize: 13, color: COLORS.subtext, marginBottom: 12 },
  ...
  chartFooterText: { marginTop: 8, fontSize: 13, color: COLORS.subtext, textAlign: 'center', fontWeight: '600' },
  ...
  floatingLabelText: { fontSize: 10, fontWeight: '700', color: COLORS.text, backgroundColor: 'rgba(255,255,255,0.95)', paddingHorizontal: 4, paddingVertical: 2, borderRadius: 6, overflow: 'hidden', textAlign: 'center' },
  ...
  mobileLegendText: { fontSize: 13, color: COLORS.text, fontWeight: '600' },
  insightCard: { backgroundColor: '#FCFCFD', borderWidth: 1, borderColor: COLORS.border, borderRadius: 14, padding: 14, marginBottom: 10 },
  insightLabel: { fontSize: 12, color: COLORS.subtext, marginBottom: 4 },
  insightValue: { fontSize: 16, fontWeight: '800', color: COLORS.text },
  ...
  emptyStateTitle: { fontSize: 15, fontWeight: '800', color: COLORS.success, marginBottom: 6 },
  emptyStateText: { fontSize: 13, color: COLORS.subtext, lineHeight: 20 },
  ...
  recentAssignmentTitle: { fontSize: 15, fontWeight: '800', color: COLORS.text },
  recentAssignmentMeta: { fontSize: 12, color: COLORS.subtext, marginTop: 4 },
  recentAssignmentScoreWrap: { alignItems: 'flex-end' },
  recentAssignmentScore: { fontSize: 20, fontWeight: '800' },
  ...
  missingWorkTitle: { fontSize: 15, fontWeight: '800', color: COLORS.text },
  missingWorkMeta: { fontSize: 12, color: COLORS.subtext, marginTop: 4 },
  ...
  subjectTitle: { fontSize: 16, fontWeight: '800', color: COLORS.text },
  subjectCode: { fontSize: 12, color: COLORS.subtext, marginTop: 2 },
  subjectRiskBadge: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 999 },
  subjectRiskBadgeText: { fontSize: 12, fontWeight: '800' },
  subjectTrend: { marginTop: 6, fontSize: 13, fontWeight: '800' },
  ...
  subjectInfoLabel: { fontSize: 12, color: COLORS.subtext, marginBottom: 4 },
  subjectInfoValue: { fontSize: 14, fontWeight: '700', color: COLORS.text },
  ...
  recommendationText: { flex: 1, fontSize: 14, color: '#374151', lineHeight: 22 },
});