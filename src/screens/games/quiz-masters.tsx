...
// 🌟 UPDATED: Removed .slice(0, 10) so it accepts ALL questions generated by the backend
...
// 🌟 UPDATED: Removed .slice(0, Math.min(6, questions.length)) so Matching Cards uses all items
            ...
            {(flashcardIsCorrect || isFlashcardAnswerVisible) && (
              <Pressable style={styles.nextButton} onPress={handleNextFlashcard}>
                <Text style={styles.nextButtonText}>
                  {flashcardIndex + 1 >= questions.length ? 'Finish Practice' : 'Next Card'}
                </Text>
              </Pressable>
            )}
          </View>
  ...
  const renderSummary = () => {
    ...
    return (
      <View style={styles.gameContainer}>
        ...
        <View style={styles.modalButtonRow}>
          <Pressable style={styles.cancelBtn} onPress={goToMenu}>
            <Text style={styles.cancelBtnText}>Play Again</Text>
          </Pressable>
          <Pressable
            style={styles.saveBtn}
  ...
  return (
    <View style={styles.container}>
      <View style={styles.topBar}>
        <Pressable onPress={mode === 'menu' ? onBack : goToMenu} style={styles.backBtn}>
