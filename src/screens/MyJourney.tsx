...
const styles = StyleSheet.create({
  ...
  selectLabel: { color: '#374151', marginBottom: 8, fontWeight: WEIGHT_EMPHASIS, fontFamily: FONT_BODY, fontSize: 13 },
  ...
  inputSuffix: { height: '100%', paddingHorizontal: 14, textAlignVertical: 'center', color: '#6B7280', fontSize: 12, fontWeight: WEIGHT_EMPHASIS, fontFamily: FONT_BODY, borderLeftWidth: 1, borderLeftColor: '#E5E7EB' },
  helperText: { marginTop: 7, color: '#6B7280', fontSize: 12, fontFamily: FONT_BODY },
  ...
  showBtnText: { color: '#fff', fontWeight: WEIGHT_EMPHASIS, fontFamily: FONT_BODY, fontSize: 14 },
  paper: { backgroundColor: '#fff', paddingHorizontal: 28, paddingVertical: 26, borderRadius: 18, elevation: 3, shadowColor: '#000', shadowOpacity: 0.08, shadowRadius: 12, borderWidth: 1, borderColor: '#E5E7EB' },
  ...
  documentTitle: { fontSize: 20, fontWeight: WEIGHT_TITLE, fontFamily: FONT_TITLE, letterSpacing: 1.2, color: '#111827', textAlign: 'center', textTransform: 'uppercase' },
  documentSubtitle: { marginTop: 4, fontSize: 13, fontWeight: WEIGHT_EMPHASIS, fontFamily: FONT_BODY, color: '#6B7280', textAlign: 'center' },
  ...
  infoLabel: { color: '#6B7280', fontWeight: WEIGHT_EMPHASIS, fontFamily: FONT_BODY, marginBottom: 4, fontSize: 11, letterSpacing: 0.5, textTransform: 'uppercase' },
  infoValue: { fontSize: 15, fontWeight: WEIGHT_EMPHASIS, fontFamily: FONT_BODY, color: '#111827' },
  ...
  tdSubject: { flex: 1, fontSize: 13, color: '#111827', fontFamily: FONT_BODY, paddingHorizontal: 10, paddingVertical: 12, borderRightWidth: 1, borderRightColor: '#D1D5DB' },
  tdDescription: { flex: 2.5, fontSize: 13, color: '#111827', fontFamily: FONT_BODY, paddingHorizontal: 10, paddingVertical: 12, borderRightWidth: 1, borderRightColor: '#D1D5DB' },
  tdSmall: { flex: 0.7, fontSize: 13, color: '#111827', fontFamily: FONT_BODY, textAlign: 'center', paddingHorizontal: 8, paddingVertical: 12, borderRightWidth: 1, borderRightColor: '#D1D5DB' },
  lastCell: { borderRightWidth: 0 },
  th: { fontWeight: WEIGHT_EMPHASIS, fontFamily: FONT_BODY, color: '#111827', fontSize: 12, letterSpacing: 0.4, textTransform: 'uppercase' },
  ...
  mobileMetaLabel: { fontSize: 10, color: '#6B7280', fontWeight: WEIGHT_EMPHASIS, fontFamily: FONT_BODY, textTransform: 'uppercase', marginBottom: 2 },
  mobileMetaValue: { fontSize: 13, color: '#111827', fontWeight: WEIGHT_EMPHASIS, fontFamily: FONT_BODY },
  ...
  emptyTitle: { fontSize: 15, fontWeight: WEIGHT_EMPHASIS, fontFamily: FONT_BODY, color: '#222', marginBottom: 4 },
  emptyText: { fontSize: 13, color: '#777', textAlign: 'center', fontFamily: FONT_BODY },
  ...
  summaryLabel: { fontSize: 11, color: '#6B7280', fontWeight: WEIGHT_EMPHASIS, fontFamily: FONT_BODY, textTransform: 'uppercase' },
  summaryValue: { marginTop: 3, fontSize: 16, color: '#111827', fontWeight: WEIGHT_EMPHASIS, fontFamily: FONT_BODY },
  ...
  footerNote: { color: '#6B7280', fontSize: 11, fontStyle: 'italic', fontFamily: FONT_BODY },
