...
const styles = StyleSheet.create({
  ...
  userGridMobile: { flexDirection: "column", gap: 0 },
  ...
  userCardMobile: { flex: 0, flexGrow: 0, flexShrink: 0, flexBasis: "auto", alignSelf: "stretch", width: "100%", height: undefined, minHeight: 0, marginBottom: 24 },
  userCardSmall: { padding: 16, marginBottom: 16 },
