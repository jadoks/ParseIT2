...
// Students can be young children, but the date of birth can never be today
...
function getBirthdayError(date: Date | null): string | null {
  ...
  if (age < MIN_STUDENT_AGE) {
    return `Student must be at least ${MIN_STUDENT_AGE} years old.`;
  }
              ...
              <View style={[styles.modalRow, isMobile && styles.modalRowStack]}>
                <View style={styles.modalCol}>
                  <BirthdayField
                    ...
                    maxDate={latestBirthdayFor(MIN_STUDENT_AGE)}
                    isMobile={isMobile}
                  />
                </View>
              </View>
