...
export default function AddAdminModal({
  ...
  onClose: () => void;
  isMobile: boolean;
  onSubmitAdmin?: (payload: AdminFormPayload) => Promise<void> | void;
  initialData?: AddAdminModalInitialData | null;
  isEditMode?: boolean;
}) {
          ...
          <View style={styles.modalHeader}>
            <View style={styles.modalHeaderLeft}>
              ...
              <View style={styles.modalHeaderTextWrap}>
                ...
                <Text style={styles.modalSubtitle}>
                  {isEditMode
                    ? "Update administrator details with the current values already filled in."
                    : "Add a new administrator by filling in the required details below."}
                </Text>
              </View>
            </View>
