                    ...
                    <View key={`${message.role}-${actualIndex}`} style={[styles.messageRow, isUser ? styles.userRow : styles.botRow]}>
                      {!isUser && (
                        <View style={styles.botLabelContainer}>
                          <MaterialCommunityIcons name="robot-outline" size={14} color="#8B0000" />
                      ...
                      <View style={[styles.messageBubble, isUser ? styles.userBubble : styles.botBubble]}>
                        {message.fileName && (
                          <View style={[styles.fileAttachment, isUser ? styles.fileAttachmentUser : styles.fileAttachmentBot]}>
                            <MaterialCommunityIcons name="file-document-outline" size={16} color={isUser ? "#FFF" : "#8B0000"} />
            ...
            <View style={styles.inputArea}>
              {selectedFile && (
                <View style={styles.selectedFileBadge}>
                  <MaterialCommunityIcons name="file-document-outline" size={16} color="#8B0000" />
...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: FONT_TITLE, fontSize: 18, fontWeight: "800", color: "#8B0000" },
  ...
  modeButtonActive: { backgroundColor: "#8B0000", shadowColor: "#8B0000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.2, shadowRadius: 4, elevation: 3 },
  ...
  botLabel: { fontFamily: FONT_BODY, fontSize: 12, fontWeight: "700", color: "#8B0000" },
  ...
  userBubble: { alignSelf: "flex-end", backgroundColor: "#8B0000", borderRadius: 18, borderTopRightRadius: 4 },
  ...
  fileAttachmentBot: { backgroundColor: '#F8F0F0', borderWidth: 1, borderColor: '#E8CCCC' },
  fileAttachmentUser: { backgroundColor: 'rgba(255,255,255,0.2)' },
  fileAttachmentText: { fontFamily: FONT_BODY, fontSize: 13, fontWeight: '600', color: '#6B0000', flex: 1 },
  ...
  selectedFileBadge: {
    flexDirection: 'row', alignItems: 'center', backgroundColor: '#F8F0F0',
    borderWidth: 1, borderColor: '#E8CCCC', paddingHorizontal: 12, paddingVertical: 8,
    borderRadius: 14, marginBottom: 10, gap: 8,
  },
  selectedFileText: { fontFamily: FONT_BODY, flex: 1, fontSize: 13, color: '#6B0000', fontWeight: '600' },
  ...
  sendBtn: {
    width: 42, height: 42, borderRadius: 21, backgroundColor: "#8B0000",
    alignItems: "center", justifyContent: "center",
    shadowColor: "#8B0000", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 6, elevation: 4,
  },
  sendBtnDisabled: { backgroundColor: "#C57F7F", shadowOpacity: 0 },
  ...
  tutorSuggestionTitle: { fontFamily: FONT_TITLE, fontSize: 12, fontWeight: "800", color: "#6B0000", textTransform: "uppercase", letterSpacing: 0.5 },
  tutorSuggestionList: { paddingRight: 10 },
  tutorSuggestionBubble: { maxWidth: 200, backgroundColor: "#FFF", borderWidth: 1, borderColor: "#E8CCCC", borderRadius: 16, paddingHorizontal: 12, paddingVertical: 10, marginRight: 10, shadowColor: "#000", shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 2, elevation: 1 },
  tutorSuggestionBubbleText: { fontFamily: FONT_BODY, color: "#111827", fontWeight: "700", fontSize: 13, lineHeight: 18 },
  tutorSuggestionScore: { fontFamily: FONT_BODY, color: "#8B0000", fontWeight: "700", fontSize: 11, marginTop: 4 },
